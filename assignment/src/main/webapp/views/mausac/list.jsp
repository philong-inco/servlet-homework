    ...
    <script>
        function deleteById(id){
            if(confirm("Bạn chắc chắn xóa bản ghi này?")){
                window.location.href = "http://localhost:8080/assignment_war_exploded/mau-sac/delete?id=" + id;
            }
        }
    </script>
</head>
    ...
    <div class="d-flex container" style="min-height: 450px;">
        ...
        <div class="w-75  mt-3">
            <div class="d-flex justify-content-between mb-3">
                <h1 class="my-2 h4 d-inline-block">Quản lý màu sắc</h1>
                <a href="/assignment_war_exploded/mau-sac/create" class="btn btn-success m-1">Thêm</a>
            </div>
            <table class="table">
                <thead>
                <tr>
                ...
                <c:forEach items="${ mausaclist }" var="ms">
                    <tr>
                        ...
                        <td class="p-1 m-0" style="width: 1px">
                            <a class="btn btn-warning btn-sm text-light" href="/assignment_war_exploded/mau-sac/edit?id=${ms.id}">Sửa</a>
                        </td>
                        <td class="p-1 m-0" style="width: 1px">
                            <button class="btn btn-danger btn-sm text-light" onclick="deleteById(${ms.id})">Xóa</button>
                        </td>
