...
<div>
    ...
    <div class="d-flex container" style="min-height: 450px;">
        ...
        <div class="w-75  mt-3">
            ...
            <div>
                <form method="POST" action="/assignment_war_exploded/mau-sac/store">
                    <div class="mt-3">
                        <label class="form-label">Mã màu sắc:</label>
                        <input class="form-control" type="text" name="ma" placeholder="Nhập mã màu sắc">
                    </div>
                    <div class="mt-3">
                        <label class="form-label">Tên màu sắc:</label>
                        <input class="form-control" type="text" name="ten" placeholder="Nhập tên màu sắc">
                    </div>
                    <div class="mt-3">
