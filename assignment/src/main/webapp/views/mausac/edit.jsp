    ...
    <div class="d-flex container" style="min-height: 450px;">
        ...
        <div class="w-75  mt-3">
            <div class="d-flex justify-content-between mb-3">
                <h1 class="my-2 h4 d-inline-block">Sửa màu sắc</h1>
                <a href="#" class="btn btn-secondary m-1">Danh sách màu sắc</a>
            </div>
            <div>
                <form id="main-form" method="POST" action="/assignment_war_exploded/mau-sac/update">
                    <div class="mt-3">
                        <label class="form-label">ID màu sắc: ${ms.id}</label>
                        <input class="form-control" type="hidden" name="id" value="${ms.id}">
                    </div>
                    <div class="mt-3">
                        <label class="form-label">Mã màu sắc: ${ms.ma}</label>
                        <input class="form-control" type="hidden" name="ma" value="${ms.ma}" placeholder="Nhập mã màu sắc">
                    </div>
                    <div class="mt-3">
                        <label class="form-label">Tên màu sắc:</label>
                        <input id="ten" class="form-control" type="text" name="ten" value="${ms.ten}" placeholder="Nhập tên màu sắc">
                    </div>
                    <div class="mt-3">
