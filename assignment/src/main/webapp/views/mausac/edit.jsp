...
<div>
    ...
    <div class="d-flex container" style="min-height: 450px;">
        ...
        <div class="w-75  mt-3">
            ...
            <div>
                <form method="POST" action="/assignment_war_exploded/mau-sac/update">
                    <div class="mt-3">
                    ...
                    <div class="mt-3">
                        ...
                        <input class="form-control" type="text" name="ma" value="${ms.ma}" placeholder="Nhập mã màu sắc">
                    </div>
                    <div class="mt-3">
                        <label class="form-label">Tên màu sắc:</label>
                        <input class="form-control" type="text" name="ten" value="${ms.ten}" placeholder="Nhập tên màu sắc">
                    </div>
                    <div class="mt-3">
