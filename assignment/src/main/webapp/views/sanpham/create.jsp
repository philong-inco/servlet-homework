    ...
    <div class="d-flex container" style="min-height: 450px;">
        ...
        <div class="w-75  mt-3">
            <div class="d-flex justify-content-between mb-3">
                <h1 class="my-2 h4 d-inline-block">Thêm sản phẩm</h1>
                <a href="/assignment_war_exploded/san-pham/list" class="btn btn-secondary m-1">Danh sách sản phẩm</a>
            </div>
            <div>
                <form method="POST" action="/assignment_war_exploded/san-pham/store">
                    <div class="mt-3">
                        <label class="form-label">Mã sản phẩm:</label>
                        <input class="form-control" type="text" name="ma" placeholder="Nhập mã sản phẩm">
                    </div>
                    <div class="mt-3">
                        <label class="form-label">Tên sản phẩm:</label>
                        <input class="form-control" type="text" name="ten" placeholder="Nhập tên sản phẩm">
                    </div>
                    <div class="mt-3">
