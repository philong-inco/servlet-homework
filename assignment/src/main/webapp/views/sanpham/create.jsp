...
<div>
    ...
    <div class="d-flex container" style="min-height: 450px;">
        ...
        <div class="w-75  mt-3">
            ...
            <div>
                <form id="main-form" method="POST" action="/assignment_war_exploded/san-pham/store">
                    <div class="mt-3">
                        <label class="form-label">Tên sản phẩm:</label>
                        <input id="ten" class="form-control" type="text" name="ten" placeholder="Nhập tên sản phẩm">
                    </div>
                    <div class="mt-3">
