...
<div>
    <!-- Header -->
    <div class="bg-danger container-fluid position-sticky top-0" style="z-index: 999999;">
                    ...
                    <tr style="position: relative";>
                        ...
                        <td class="p-1 m-0" style="width: 1px">
                            ...
                            <div class="border border-danger rounded shadow bg-light" id="${sp.id}"
                                 style="display: none; position: absolute; top: 40px; right: 0; z-index: 9999; max-height: 200px; overflow-y: auto">
