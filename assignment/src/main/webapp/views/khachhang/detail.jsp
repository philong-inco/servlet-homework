    ...
    <div class="d-flex container" style="min-height: 450px;">
        ...
        <div class="w-75  mt-3">
            <div class="d-flex justify-content-between mb-3">
                <h1 class="my-2 h4 d-inline-block">Chi tiết khách hàng</h1>
                <a href="#" class="btn btn-secondary m-1">Danh sách khách hàng</a>
            </div>
            <div>
                <form method="GET" action="/assignment_war_exploded/khach-hang/edit?${kh.id}">
                    <div class="mt-3">
                    ...
                    <div class="mt-3">
                        ...
                        <input class="form-control" type="text" name="ma" value="${kh.maKH}" disabled>
                    </div>
                    <div class="mt-3">
                        <label class="form-label">Tên khách hàng:</label>
                        <input class="form-control" type="text" name="ten" value="${kh.ten}" disabled>
                    </div>
                    <div class="mt-3">
                        <label class="form-label">SĐT khách hàng:</label>
                        <input class="form-control" type="text" name="sdt" value="${kh.sdt}" disabled>
                    </div>
                    <div class="mt-3">
