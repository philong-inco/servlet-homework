...
<div>
    ...
    <div class="d-flex container" style="min-height: 450px;">
        ...
        <div class="w-75  mt-3">
            ...
            <div>
                <form method="POST" action="/assignment_war_exploded/khach-hang/store">
                    <div class="mt-3">
                        <label class="form-label">Mã khách hàng:</label>
                        <input class="form-control" type="text" name="ma" placeholder="Nhập mã khách hàng">
                    </div>
                    <div class="mt-3">
                        <label class="form-label">Tên khách hàng:</label>
                        <input class="form-control" type="text" name="ten" placeholder="Nhập tên khách hàng">
                    </div>
                    <div class="mt-3">
