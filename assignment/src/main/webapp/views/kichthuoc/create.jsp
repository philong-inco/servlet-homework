...
<div>
    ...
    <div class="d-flex container" style="min-height: 450px;">
        ...
        <div class="w-75  mt-3">
            ...
            <div>
                <form method="POST" action="/assignment_war_exploded/kich-thuoc/store">
                    <div class="mt-3">
                        <label class="form-label">Mã kích thước:</label>
                        <input class="form-control" type="text" name="ma" placeholder="Nhập mã kích thước">
                    </div>
                    <div class="mt-3">
                        <label class="form-label">Tên kích thước:</label>
                        <input class="form-control" type="text" name="ten" placeholder="Nhập tên kích thước">
                    </div>
                    <div class="mt-3">
