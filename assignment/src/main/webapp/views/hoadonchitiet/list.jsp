...
<div class="mt-3 container">
    <nav class="navbar navbar-expand-sm bg-light">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-danger" href="http://localhost:8080/assignment_war_exploded/hoa-don-chi-tiet">Hóa đơn chi tiết</a>
                </li>
                <li class="nav-item">
    ...
    <h1 class="text-center my-3">Hóa Đơn chi tiết</h1>
    <table class="table">
        <thead>
        <tr>
            <th>ID</th>
