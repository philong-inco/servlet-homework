...
<div>
    ...
    <div class="d-flex container" style="min-height: 450px;">
        ...
        <div class="w-75  mt-3">
            ...
            <div>
                <form method="POST" action="/assignment_war_exploded/nhan-vien/update">
                    <div class="mt-3">
                    ...
                    <div class="mt-3">
                        ...
                        <input class="form-control" type="text" name="ma" value="${nv.maNV}" placeholder="Nhập mã nhân viên">
                    </div>
                    <div class="mt-3">
                        <label class="form-label">Tên nhân viên:</label>
                        <input class="form-control" type="text" name="ten" value="${nv.ten}" placeholder="Nhập tên nhân viên">
                    </div>
                    <div class="mt-3">
                        <label class="form-label">Username:</label>
                        <input class="form-control" type="text" name="username" value="${nv.tenDangNhap}">
                    </div>
                    <div class="mt-3">
                        <label class="form-label">Mật khẩu:</label>
                        <input class="form-control" type="text" name="matkhau" value="${nv.matKhau}">
                    </div>
                    <div class="mt-3">
