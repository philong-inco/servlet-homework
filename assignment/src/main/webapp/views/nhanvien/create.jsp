...
<div>
    ...
    <div class="d-flex container" style="min-height: 450px;">
        ...
        <div class="w-75  mt-3">
            ...
            <div>
                <form id="main-form" method="POST" action="/assignment_war_exploded/nhan-vien/store">
                    <div class="mt-3">
                        <label class="form-label">Tên nhân viên:</label>
                        <input id="ten" class="form-control" type="text" name="ten" placeholder="Nhập tên nhân viên">
                    </div>
                    <div class="mt-3">
                        <label class="form-label">Username:</label>
                        <input id="userName" class="form-control" type="text" name="username" placeholder="Nhập username">
                    </div>
                    <div class="mt-3">
                        <label class="form-label">Mật khẩu:</label>
                        <input id="matKhau" class="form-control" type="password" name="matkhau" placeholder="Nhập mật khẩu">
                    </div>
                    <div class="mt-3">
