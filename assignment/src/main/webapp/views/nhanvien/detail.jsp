    ...
    <div class="d-flex container" style="min-height: 450px;">
        ...
        <div class="w-75  mt-3">
            <div class="d-flex justify-content-between mb-3">
                <h1 class="my-2 h4 d-inline-block">Chi tiết nhân viên</h1>
                <a href="/assignment_war_exploded/nhan-vien/list" class="btn btn-secondary m-1">Danh sách nhân viên</a>
            </div>
            <div>
                <form method="GET" action="/assignment_war_exploded/nhan-vien/edit?${nv.id}">
                    <div class="mt-3">
                    ...
                    <div class="mt-3">
                        ...
                        <input class="form-control" type="text" name="ma" value="${nv.maNV}" disabled>
                    </div>
                    <div class="mt-3">
                        <label class="form-label">Tên nhân viên:</label>
                        <input class="form-control" type="text" name="ten" value="${nv.ten}" disabled>
                    </div>
                    <div class="mt-3">
                        <label class="form-label">Username:</label>
                        <input class="form-control" type="text" name="username" value="${nv.tenDangNhap}" disabled>
                    </div>
                    <div class="mt-3">
                        <label class="form-label">Mật khẩu:</label>
                        <input class="form-control" type="text" name="matkhau" value="${nv.matKhau}" disabled>
                    </div>
                    <div class="mt-3">
